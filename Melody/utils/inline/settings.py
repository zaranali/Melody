...
def vote_mode_markup(_, current, mode: Union[bool, str] = None):
    buttons = [
        [
            InlineKeyboardButton(text="✨ Voting Mode", callback_data="VOTEANSWER", style=ButtonStyle.PRIMARY),
...
def playmode_users_markup(
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text="⚡️ " + _["ST_B_11"] if Direct else "🌐 " + _["ST_B_12"],
        ...
        [
            ...
            InlineKeyboardButton(
                text="👨‍✈️ " + _["ST_B_8"] if Group else "👥 " + _["ST_B_9"],
