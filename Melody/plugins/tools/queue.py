...
from Melody.utils import MelodyBin, get_channeplayCB, seconds_to_min
from Melody.utils.database import get_cmode, is_active_chat, is_music_playing
from Melody.utils.decorators.language import language, languageCB
from Melody.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    await CallbackQuery.edit_message_text(_["queue_1"], reply_markup=buttons)
    j = 0
    msg = ""
    for x in got:
        j += 1
