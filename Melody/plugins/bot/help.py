...
from Melody.utils.database import get_lang
from Melody.utils.decorators.language import LanguageStart, languageCB
from Melody.utils.inline.help import (
    help_back_markup,
    private_help_panel,
    help_pannel_page1,
    help_pannel_page2,
...
async def helper_private(
    ...
    if is_callback:
        ...
        from Melody.utils.inline.help import help_pannel_page1
        keyboard = help_pannel_page1(_, True)
        await update.edit_message_text(
            _["help_1"].format(f"https://t.me/{SUPPORT_GROUP}"), reply_markup=keyboard
        )
    else:
        try:
            await update.delete()
...
async def help_com_group(client, message: Message, _):
    from Melody.utils.inline.help import private_help_panel
...
async def helper_cb(client, CallbackQuery, _):
    ...
    def get_keyboard_for(cb):
        ...
        page2 = ["hb11", "hb12", "hb13", "hb14", "hb15", "hb16", "hb20"]
        page3 = ["hb21", "hb23", "hb24", "hb29", "hb39"]
