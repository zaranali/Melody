...
from Melody.utils import AdminRightsCheck
from Melody.utils.database import is_active_chat, is_nonadmin_chat
from Melody.utils.decorators.language import languageCB
from Melody.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await MelodyCall.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
